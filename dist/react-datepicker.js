	      ...
	      if (this.props.dateFormat === 'DD/MM/YYYY') {
	        ...
	        if (value === '' || value === undefined) {
	          ...
	          var _value$split = value.split('/'),
	              ...
	              newDate = _value$split2[0],
	              newMonth = _value$split2[1],
	              newYear = _value$split2[2];

	          newDate && currentDate.set('date', newDate);
	          newMonth && currentDate.set('month', newMonth - 1);
	          newMonth && currentDate.set('year', (0, _moment2.default)(newYear, 'YYYY').format('YYYY'));

	          if (!(0, _moment2.default)(currentDate).isValid()) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _month = __webpack_require__(137);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _week = __webpack_require__(138);
